...
def test_orchestrator_entrypoint_keeps_legacy_import_compatible() -> None:
    from services.orchestrator_service.app.main import app as package_app
    from services.orchestrator_service.main import app as legacy_app

    assert legacy_app is package_app
    assert package_app.title == "orchestrator-service"
