...
async def get_status(request: Request):
    ...
    return {
        ...
        "totalHaveDoneProcessTasks": stats.get("online", 0),
        "totalFailedTasks": stats.get("total_failed_tasks", 0),
        "onlineDone": stats.get("online", 0),
        "queuedTaskList": stats.get("queued_task_ids", []),
        "processingTaskList": stats.get("processing_task_ids", []),
    }
