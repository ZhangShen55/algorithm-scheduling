...
- 输出目录: `/Users/zhangshen/Documents/workspace/jy-algorithm-tias-server/tests/student_behavior_eval2`
- 图片数量: 110
- 原始候选框最低 conf: 0.1
...
| 标签 | 阈值 |
| --- | ---: |
| 使用手机 (Using_phone) | 0.500 |
| 举手 (Hand_raising) | 0.990 |
| 睡觉 (Sleep) | 0.450 |
| 站立 (standing) | 0.990 |
| 阅读 (Read_W) | 0.500 |
