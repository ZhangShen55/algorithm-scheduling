...
def test_blocking_repository_and_redis_routes_are_sync_endpoints(
    ...
    blocking_paths = (
        ...
        "/ops/course-jobs",
        "/ops/course-jobs/{task_id}/summary",
        "/ops/course-jobs/{task_id}/task-types/{task_type}",
        "/ops/course-jobs/{task_id}/task-types/{task_type}/result",
        "/ops/course-jobs/{task_id}/events",
